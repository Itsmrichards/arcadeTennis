...
function scene:create( event )
	...
	local background = display.newImage( sceneGroup, backgroundSheet, 1 )
	...
	local bg3 = display.newImage( sceneGroup, backgroundSheet, 3 )
	bg3.x = 160
	bg3.y = -40;
	bg3:rotate( 90 )
	bg3.yScale = 5

	local bg7 = display.newImage( sceneGroup, backgroundSheet, 3 )
	bg7.x = 4
	bg7.y = 230;
	bg7.yScale = 10

	local bg8 = display.newImage( sceneGroup, backgroundSheet, 3 )
	bg8.x = 270
	bg8.y = 230;
	bg8.yScale = 10

	local bg2 = display.newImage( sceneGroup, backgroundSheet, 2 )
	bg2.x = 50
	bg2.y = 6;

	local bg4 = display.newImage( sceneGroup, backgroundSheet, 2 )
	bg4.x = 270
	bg4.y = 6;
	bg4:rotate( 180 )
	bg4.yScale = -1

	local bg4 = display.newImage( sceneGroup, backgroundSheet, 3 )
	bg4.x = 160
	bg4.y = 480;
	bg4:rotate( 90 )
	bg4.yScale = 5

	local bg5 = display.newImage( sceneGroup, backgroundSheet, 2 )
	bg5.x = 270
	bg5.y = 480;
	bg5:rotate( 180 )

	local bg6 = display.newImage( sceneGroup, backgroundSheet, 2 )
	bg6.x = 50
	bg6.y = 480;
	bg6:rotate( 0 )
	bg6.yScale = -1
	...
	net:scale( 4, 1 )
	sceneGroup:insert( netGroup )

	-- Players --
	--local playerGroup = display.newGroup( )
	--playerGroup.x, playerGroup.y = _CX, 480
	local player = display.newImage( sceneGroup, "kenney_sportspack/PNG/Green/characterGreen (1).png")
	player.x, player.y = _CX, 480
	player:scale( 1.5, 1.5 )
	player:rotate( 270 )

	-- Tennis Racket --
	local racket = display.newImage( sceneGroup, "kenney_sportspack/PNG/Equipment/racket_metal.png")
	racket.x, racket.y = _CX + 30, 465

	local enemy = display.newImage( sceneGroup, "kenney_sportspack/PNG/Blue/characterBlue (1).png")
	enemy.x, enemy.y = _CX, 20
	enemy:scale( 1.5, 1.5 )
	enemy:rotate( 90 )

	local enemyRacket = display.newImage( sceneGroup, "kenney_sportspack/PNG/Equipment/racket_metal.png")
	...
	-- Tennis Ball --
	ball = display.newImage( sceneGroup, "kenney_sportspack/PNG/Equipment/ball_tennis1.png", _CX, 300)
	ball:scale( 1.5, 1.5 )
